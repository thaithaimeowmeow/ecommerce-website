...
<div class="pt-5 text-center">
    <h1 class="display-4 fw-bolder text-break">Kết quả tìm kiếm cho "{{$query}}"</h1>
</div>
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        ...
        @else
        <div class="pt-5 text-center">
            <img src="/storage/notfound.png" alt="">
            <h1 class="fw-bolder pt-3 text-break">Không tìm thấy sản phẩm nào.</h1>
        </div>
        @endif
    </div>
</section>
